...
[Определение](async_promises.md#определение) • [Состояния](async_promises.md#состояния) • [Способ использования](async_promises.md#способ-использования) • [Создание промиса](async_promises.md#создание-промиса) • [Добавление обработчиков](async_promises.md#добавление-обработчиков)
...
> [Промисы](async_promises.md), раздел "[Создание промиса](async_promises.md#создание-промиса)"
