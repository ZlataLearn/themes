...
*Названия: "асинхронные функции", "асинхронными функциями"*

> [Асинхронность](async_basics.md), раздел "[Способы обработки асинхронности](async_basics.md#способы-обработки-асинхронности)"<br />[Промисы](async_promises.md), раздел "[Промисификация](async_promises.md#промисификация)"
